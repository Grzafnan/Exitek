import { teamMeting } from '@/assets';

const JoinTeam = () => {
  return (
    <section
      className={`w-full min-h-[500px] flex flex-col justify-center items-center bg-cover bg-center relative`}
